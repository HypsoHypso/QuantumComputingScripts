...
print(
    ("Non-maximal entanglement", "Maximum entanglement")[
        counts.get("01") == counts.get("10")
    ]
)
...
counts_exp = result_exp.get_counts(circuit)  # Get the result
...
print(
    ("Non-maximal entanglement", "Maximum entanglement")[
        counts_exp.get("01") == counts_exp.get("10")
    ]
)
